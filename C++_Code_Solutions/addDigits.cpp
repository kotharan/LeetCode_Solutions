...
class Solution {
    public:
        ...
        int addDigits(int num) {
            ...
            switch(rand()%5+1){  // It gives range 0..5 therefore added one to get 1..6
        ...
        //This solution looks is very tricky, but actually it is easy to understand.
